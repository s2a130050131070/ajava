...
public class bankinfo {
   ...
   static final String DB_URL = "jdbc:postgresql://127.0.0.1:5432/s2d130050131069";
 ...
 Double ph,acno;
  ...
  try{
      ...
      System.out.println(" \n Connecting to a  s2d130050131069 database");
	   ...
	   Scanner sc=new Scanner(System.in);
            while(i!=1){
                ...
                switch(ch){
                    ...
                    case 1:
                        stmt=con.prepareStatement("insert into Bank1 values(?,?,?,?,?)");
                    ...
                    case 2:
                        stmt=con.prepareStatement("update Bank1 set balance=? where acc_no= ?");  
                        System.out.print("Enter Account No:");
                        acno=sc.nextDouble();
                        System.out.print("Enter balance:");
                        bal=sc.nextDouble();
                        ...
                        break;
                    case 3:
                        stmt=con.prepareStatement("delete from Bank1 where acc_no=?");
                        System.out.print("Enter Account No:");
                        acno=sc.nextDouble();
                        stmt.setDouble(1,acno);
                        stmt.executeUpdate();
					...
					case 4:
						  ...
						  String sql = "select * from bank1 where balance > "+Amount+"";
